...
public class sEnglandInfo : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            InfoTextSe = GameObject.Find("TextBox").GetComponent<Text>();
            InfoTextSe.text = ("“The Three Lions” were first used by King Richard I (The Lion Heart) 1189-1199, " +
