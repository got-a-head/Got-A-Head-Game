...
public class SwordInfo : MonoBehaviour
{
    ...
    public Text InfoTextSw;

    // Start is called before the first frame update
    void Start()
    {
        InfoTextSw = GameObject.Find("TextBox").GetComponent<Text>();
    }
    ...
    void Update()
    {
        ...
        {
            InfoTextSw.text = ("Most swords have four main parts: blade, guard, hilt and pommel.\n" +
