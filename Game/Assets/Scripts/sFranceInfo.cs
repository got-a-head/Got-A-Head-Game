...
public class sFranceInfo : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            InfoTextSf = GameObject.Find("TextBox").GetComponent<Text>();
            InfoTextSf.text = ("In the UK we have the Prince of Wales as the title given to the heir to the throne." +
